...
#for cleaning the all .xlsx file
for file in dbutils.fs.ls('/FileStore/tables/'):
...
temp_table_name = "sample_student_csv"
...
# MAGIC
# MAGIC select * from `sample_student_csv`
...
permanent_table_name = "sample_student_csv"
